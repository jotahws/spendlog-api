...
export const formatQr = (input: string): Expense => {
    ...
    return {
        ...
        totalReducedRateVatI: formatNumber(values["14"]),
        taxableBaseIntermediateRateVatI: formatNumber(values["15"]),
        totalIntermediateRateVatI: formatNumber(values["I6"]),
        taxableBaseNormalRateVatI: formatNumber(values["I7"]),
        totalNormalRateVatI: formatNumber(values["18"]),
        fiscalSpaceJ: values["J1"],
        taxableBaseExemptVatJ: formatNumber(values["12"]),
